            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide flex flex-col sm:flex-row">
                                <div class="w-full sm:w-1/2 sm:order-2">
                                    <img src="{{url('/img/baldafrique.png')}}" alt="logo" class="h-96 mx-auto sm:mx-0 sm:ml-auto sm:mr-0" />
                                </div>
                            ...
                            <div class="swiper-slide flex flex-col sm:flex-row">
                                <div class="w-full sm:w-1/2">
                                    <img src="{{url('/img/lessablesroses.jpg')}}" alt="logo" class="h-96 mt-10 mx-auto sm:ml-0 sm:mr-auto" />
                                </div>
                                <div class="w-full sm:w-1/2 p-4">
                            ...
                            <div class="swiper-slide flex flex-col sm:flex-row">
                                <div class="w-full sm:w-1/2 sm:order-2">
                                    <img src="{{url('/img/logo.png')}}" alt="logo" class="h-28 sm:h-96 mx-auto sm:mx-0 sm:ml-auto sm:mr-0" />
                                </div>
                                <div class="w-full sm:w-1/2 sm:order-1 p-4">
                        ...
                        <div class="swiper-pagination mb-16"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="p-6 text-gray-900 flex flex-col sm:flex-row">
                        <div class="w-full sm:w-1/2 sm:pr-4">
                            <div class="bg-gray-100 p-4 rounded-md shadow-md">
                                <h4 class="font-semibold mb-2">Boutique</h4>
                                <a href="https://www.jovoyparis.com/fr/" class="block mb-2">
                                    <img src="{{url('/img/jovoy-logo.png')}}" alt="logo" class="h-44" />
                                </a>
                                <a href="https://noseparis.com/fr/" class="block">
                                    <img src="{{url('/img/nose-logo.png')}}" alt="logo" class="" />
                                </a>
                            </div>
                        </div>
                        <div class="w-full sm:w-1/2 mt-4 sm:mt-0 sm:pl-4">
                            <div class="bg-gray-100 p-4 rounded-md shadow-md">
                                <h4 class="font-semibold mb-2">Collectionneur Instagram</h4>
                                <a href="https://www.instagram.com/maxforti/" class="block mb-2">@maxforti</a>
                                <a href="https://www.instagram.com/fragrenturesofmark/" class="block mb-2">@fragranturesofmark</a>
                            ...
                            <!-- Ajoutez des images pour chaque collectionneur si nécessaire -->
                        </div>
                    </div>
                </div>
            </div>
